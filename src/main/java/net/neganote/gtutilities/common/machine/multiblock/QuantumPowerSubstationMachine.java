...
// Copied wholesale and then modified from PSS code in GTm
@SuppressWarnings("unused")
public class QuantumPowerSubstationMachine extends WorkableMultiblockMachine
                                           implements IEnergyInfoProvider, IFancyUIMachine, IDisplayUIMachine {

    protected static final ManagedFieldHolder MANAGED_FIELD_HOLDER = new ManagedFieldHolder(
            QuantumPowerSubstationMachine.class, WorkableMultiblockMachine.MANAGED_FIELD_HOLDER);
