        ...
        if (GTCEu.Mods.isAE2Loaded()) {
            ...
            if (UtilConfig.INSTANCE.features.tagStockingEnabled || GTCEu.isDataGen()) {
                ME_TAG_STOCKING_INPUT_BUS = REGISTRATE
                        ...
                        .tooltips(
                                ...
                                Component.translatable("block.gtmutils.tag_stocking_bus.desc.0"),
                                Component.translatable("block.gtmutils.tag_stocking_bus.desc.1"),
                                Component.translatable("block.gtmutils.tag_stocking_bus.desc.2"),
                                Component.translatable("gtceu.part_sharing.enabled"))
                        .register();
            }
            ...
            if (UtilConfig.INSTANCE.features.enlargedStockingEnabled || GTCEu.isDataGen()) {
                ME_ENLARGED_STOCKING_INPUT_BUS = REGISTRATE
                        ...
                        .tooltips(
                                Component.translatable("gtceu.machine.item_bus.import.tooltip"),
                                Component.translatable("block.gtmutils.enlarged_stocking_bus.desc.0"),
                                Component.translatable("block.gtmutils.enlarged_stocking_bus.desc.1"),
                                Component.translatable("block.gtmutils.enlarged_stocking_bus.desc.2"),
                                Component.translatable("gtceu.part_sharing.enabled"))
                        .register();
            }
            ...
            if ((UtilConfig.INSTANCE.features.enlargedStockingEnabled &&
                ...
                ME_ENLARGED_TAG_STOCKING_INPUT_BUS = REGISTRATE
                        ...
                        .tooltips(
                                Component.translatable("gtceu.machine.item_bus.import.tooltip"),
                                Component.translatable("block.gtmutils.tag_enlarged_stocking_bus.desc.0"),
                                Component.translatable("block.gtmutils.tag_enlarged_stocking_bus.desc.1"),
                                Component.translatable("block.gtmutils.tag_enlarged_stocking_bus.desc.2"),
                                Component.translatable("gtceu.part_sharing.enabled"))
                        .register();
            }
            ...
            if (UtilConfig.INSTANCE.features.tagStockingEnabled || GTCEu.isDataGen()) {
                ME_TAG_STOCKING_INPUT_HATCH = REGISTRATE
                        ...
                        .tooltips(
                                ...
                                Component.translatable("block.gtmutils.tag_stocking_hatch.desc.0"),
                                Component.translatable("block.gtmutils.tag_stocking_hatch.desc.1"),
                                Component.translatable("block.gtmutils.tag_stocking_hatch.desc.2"),
                                Component.translatable("gtceu.part_sharing.enabled"))
                        .register();
            }
            ...
            if (UtilConfig.INSTANCE.features.enlargedStockingEnabled || GTCEu.isDataGen()) {
                ME_ENLARGED_STOCKING_INPUT_HATCH = REGISTRATE
                        ...
                        .tooltips(
                                Component.translatable("gtceu.machine.fluid_hatch.import.tooltip"),
                                Component.translatable("block.gtmutils.enlarged_stocking_hatch.desc.0"),
                                Component.translatable("block.gtmutils.enlarged_stocking_hatch.desc.1"),
                                Component.translatable("block.gtmutils.enlarged_stocking_hatch.desc.2"),
                                Component.translatable("gtceu.part_sharing.enabled"))
                        .register();
            }
            ...
            if ((UtilConfig.INSTANCE.features.enlargedStockingEnabled &&
                ...
                ME_ENLARGED_TAG_STOCKING_INPUT_HATCH = REGISTRATE
                        ...
                        .tooltips(
                                Component.translatable("gtceu.machine.fluid_hatch.import.tooltip"),
                                Component.translatable("block.gtmutils.tag_enlarged_stocking_hatch.desc.0"),
                                Component.translatable("block.gtmutils.tag_enlarged_stocking_hatch.desc.1"),
                                Component.translatable("block.gtmutils.tag_enlarged_stocking_hatch.desc.2"),
                                Component.translatable("gtceu.part_sharing.enabled"))
                        .register();
            }
        }
