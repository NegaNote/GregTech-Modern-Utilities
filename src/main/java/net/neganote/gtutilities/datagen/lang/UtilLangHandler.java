...
public class UtilLangHandler {
    ...
    public static void init(RegistrateLangProvider provider) {
        ...
        provider.add("block.gtmutils.tag_stocking_bus.desc",
                """
